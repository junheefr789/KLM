...
class Ui_Dialog(QtWidgets.QDialog):
    ...
    def setupUi(self):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(self.width*0.02, self.height*0.65, self.width*0.46, self.height*0.3))
        ...
        self.pushButton_3.setText('아 니 오')
